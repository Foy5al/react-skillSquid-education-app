        ...
        <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
            ...
            <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
                ...
                <div className="flex justify-center">
                    <a href="https://www.facebook.com/iamfoysal.h" className="mr-6 text-gray-600" target="_blank" rel="noreferrer noopener">
                    ...
                    <a href="https://twitter.com/DrkFaisal" className="mr-6 text-gray-600" target="_blank" rel="noreferrer noopener">
                    ...
                    <a href="https://www.instagram.com/programminghero/" className="mr-6 text-gray-600" target="_blank" rel="noreferrer noopener">
                    ...
                    <a href="https://www.linkedin.com/in/md-foysal-h/" className="mr-6 text-gray-600" target="_blank" rel="noreferrer noopener">
                    ...
                    <a href="https://github.com/Foy5al" className="text-gray-600" target="_blank" rel="noreferrer noopener">
          ...
          ">
            ...
            <div className="text-center p-6 bg-gray-200">
                ...
                <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">Mohammad Foysal</a>
            </div>
        </footer>
    );
};
